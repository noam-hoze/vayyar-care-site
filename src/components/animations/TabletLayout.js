 ...
 */
const TabletLayout = ({ children, time = '9:41 AM', showChatInput = false, showMetrics = false, criticalMetric = 0, inputValue = '' }) => {
  ...
  if (showChatInput && showMetrics) contentClassModifiers.push('with-chat-and-metrics');
        ...
        <div className="tablet-screen">
          ...
          {showMetrics && (
            <div className="tablet-layout-metrics">
              ...
              <div className="tablet-layout-metrics-item">
                <div className={`tablet-layout-metrics-item-value ${criticalMetric > 0 ? 'alert' : 'normal'}`}>
                  {criticalMetric}
                </div>
                <div className="tablet-layout-metrics-item-label">
                  Critical
              ...
              <div className="tablet-layout-metrics-item">
                <div className="tablet-layout-metrics-item-value monitored">
                  100%
                </div>
                <div className="tablet-layout-metrics-item-label">
                  Monitored
          ...
          {/* Chat Input */}
          {showChatInput && (
            <div className="tablet-layout-chat-input">
              <div className="tablet-layout-chat-input-container">
                <input 
                  type="text"
