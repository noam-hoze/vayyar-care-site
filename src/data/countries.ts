...
// Source: Consolidated from ITU/E.164 allocations and common country names.
// Names are the common English names expected by typical CRM fields.
...
export const dialCodesSorted = Array.from(
    new Set(countries.map((c) => c.dialCode))
)
