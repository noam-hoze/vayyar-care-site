export const scenes = [
  ...
  {
    title: "",
    description: "Resident walks with a walker. Subtle gait analysis UI overlays the path. Tablet highlights anomalies.",
    cameraDirection: "Side dolly following walking resident with tablet HUD.",
  ...
  {
    title: "",
    description: "Dining room is busy. Tablet notifies of increased bathroom visits. Nurse flags issue quietly.",
    cameraDirection: "Glide through dining space, HUDs hover near tables.",
  ...
  {
    title: "",
    description: "Nurse sits calmly at desk. Tablet shows pre-filled report suggestions. She taps to approve.",
    cameraDirection: "Slow orbit around nurse, soft light over screen.",
  ...
  {
    title: "",
    description: "Team huddles. Tablet floats in middle with comparison graphs. Everyone glances at the shared view.",
    cameraDirection: "Top-down tilt shot into flat table view, then tablet pop-up.",
  ...
  {
    title: "",
    description: "Back at the station. The nurse hands over. Tablet flips UI. Everything is summarized.",
    cameraDirection: "Zoom out, rotating tablet flips data to new nurse.",
  ...
  {
    title: "",
    description: "Dark corridors. Silent tablet notifications. Sleep indicators hover like stars.",
    cameraDirection: "Slow glide past rooms, only soft glow from tablet.",
    sceneEmotion: "Peace of mind, quiet control",
    subtitle: "",
  ...
  {
    title: "",
    description: "Sunlight returns. Tablet refreshes with new shift data. System continues — no reset needed.",
    cameraDirection: "Pull back out of building, sunrise warms everything.",
